<template>
    <div class="row mt-3">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-header bg-dark text-white text-center">New product</div>
                <div class="card-body">
                    <form v-on:submit="createProduct">
                        ...
                        <div class="d-grid col-6 mx-auto">
                            <button class="btn btn-success" ><i class="fa-solid fa-floppy-disk">  Create</i></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        methods:{
            createProduct(){
                ...
                if(this.name.trim() === ''){
                    ...
                    sendRequest('POST', params, this.url, 'Producto creado')
                }
            }
        }
    }
